...
static dword                           ag_fbsz;
static word*                           ag_fbuf;   //-- FrameBuffer Direct Memory
static dword*                           ag_fbuf32;
static word*                           ag_b;      //-- FrameBuffer Cache Memory
static dword*                          ag_bf32;
static dword*                          ag_b32;
static word*                           ag_bz;     //-- FrameBuffer Cache Memory
